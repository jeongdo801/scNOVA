...
#for (k in 1:subclone_count){
	...
	if (IQR(log10(Deeptool_result_final_metric_sub[,1]+1))!=0){fit1<-smooth.spline(log10(Deeptool_result_final_metric_sub[,1]+1), Deeptool_result_final_metric_sub[,3]^2, df=16)}
	if (IQR(log10(Deeptool_result_final_metric_sub[,1]+1))==0){fit1<-smooth.spline(log10(Deeptool_result_final_metric_sub[,1]+1), Deeptool_result_final_metric_sub[,3]^2, df=16, tol=1e-6 * 0.146128)}
